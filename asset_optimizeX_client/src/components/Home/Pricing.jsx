...
const Pricing = () => {
  return (
    ...
    <div className="relative w-full h-full">
      <div className="absolute hidden w-full bg-slate-200 lg:block h-96" />
      <div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <p className="text-base text-gray-700 md:text-lg">
            ...
            <span>Keep all of your assets in one place</span>
            ...
            <div className="p-8 bg-gray-900 rounded">
              ...
              <ul className="mb-8 space-y-2">
                <li className="flex items-center">
                  <FcCheckmark className="mr-4"/>
                  <p className="font-medium text-gray-300">Add upto 3 members.</p>
                </li>
                <li className="flex items-center">
                <FcCheckmark className="mr-4"/>
                  <p className="font-medium text-gray-300">Limited Library Creation.</p>
                </li>
                <li className="flex items-center">
                <FcCheckmark className="mr-4"/>
                  <p className="font-medium text-gray-300">Limited Asset Upload.</p>
                </li>
                <li className="flex items-center">
                <FcCheckmark className="mr-4"/>
                  <p className="font-medium text-gray-300">Limited Storage.</p>
                </li>
                <li className="flex items-center">
                <FcCheckmark className="mr-4"/>
                  <p className="font-medium text-gray-300">Unlimited Download.</p>
                </li>
          ...
          <div>
            <div className="p-8 bg-gray-900 rounded">
              ...
              <ul className="mb-8 space-y-2">
                <li className="flex items-center">
                <FcCheckmark className="mr-4"/>
                  <p className="font-medium text-gray-300">Storage upto 100 GB</p>
                </li>
                <li className="flex items-center">
                <FcCheckmark className="mr-4"/>
                  <p className="font-medium text-gray-300">Unlimited Collaboration</p>
                </li>
                <li className="flex items-center">
                <FcCheckmark className="mr-4"/>
                  <p className="font-medium text-gray-300">Unlimited Library Creation</p>
                </li>
                <li className="flex items-center">
                <FcCheckmark className="mr-4"/>
                  <p className="font-medium text-gray-300">Unlimited Asset Upload</p>
                </li>
                <li className="flex items-center">
                <FcCheckmark className="mr-4"/>
                  <p className="font-medium text-gray-300">Advance Feature Access</p>
                </li>
              </ul>
              <a href="">
              <button
