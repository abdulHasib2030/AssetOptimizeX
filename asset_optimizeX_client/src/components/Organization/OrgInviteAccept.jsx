...
const OrgInviteAccept = () => {
    ...
    const handleSubmit = ()=> {
        ...
        axios.post(`/api/organization/add-user/${uid}/${user_matching_query}/${hash}/`)
        .then((res)=> {
            if(res.data){
                setServerMsg(res.data.massage)
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-5 bg-gray-600 min-w-screen">
            <div className="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
                <h3 className="text-2xl">Your Organization Invitation</h3>
                ...
                <p>We&apos;re happy you&apos;re here. Let&apos;s get into our Organization:</p>
                ...
                <div className="mt-4">
                    <button onClick={handleSubmit} className="btn btn-block btn-primary">Click to Accept Invite</button>
                </div>
            </div>
        </div>
  )
